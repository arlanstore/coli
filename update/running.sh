...
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "$blu$blu✘$NC$NC Hostname    : $HOSTNAME"
echo -e "$blu✘$NC OS Name     : $Tipe"
#echo -e "Processor   : $tipeprosesor"
#echo -e "Proc Core   :$totalcore"
#echo -e "Virtual     :$typevps"
#echo -e "Cpu Usage   :$cpu_usage"
echo -e "$blu✘$NC Total RAM   : ${totalram}MB"
echo -e "$blu✘$NC Public IP   : $MYIP"
echo -e "$blu✘$NC Domain      : $Domain"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "\E[44;1;39m          ⇱ Subscription Information ⇲          \E[0m"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "$blu✘$NC Client Name : $Name"
echo -e "$blu✘$NC Exp Script  : $Exp"
echo -e "$blu✘$NC Version     : Latest Version"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "\E[44;1;39m            ⇱ Service Information ⇲             \E[0m"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo -e "$blu✘$NC SSH / TUN               :$status_ssh"
echo -e "$blu✘$NC OpenVPN                 :$status_openvpn"
echo -e "$blu✘$NC Dropbear                :$status_beruangjatuh"
echo -e "$blu✘$NC Stunnel5                :$status_stunnel"
echo -e "$blu✘$NC Fail2Ban                :$status_fail2ban"
echo -e "$blu✘$NC Crons                   :$status_cron"
echo -e "$blu✘$NC Vnstat                  :$status_vnstat"
echo -e "$blu✘$NC L2TP                    :$status_l2tp"
echo -e "$blu✘$NC SSTP                    :$status_sstp"
echo -e "$blu✘$NC XRAYS Vmess TLS         :$status_tls_v2ray"
echo -e "$blu✘$NC XRAYS Vmess None TLS    :$status_nontls_v2ray"
echo -e "$blu✘$NC XRAYS Vless TLS         :$status_tls_vless"
echo -e "$blu✘$NC XRAYS Vless None TLS    :$status_nontls_vless"
echo -e "$blu✘$NC Shadowsocks-OBFS HTTP   :$status_ssh"
echo -e "$blu✘$NC XRAYS Trojan            :$status_virus_trojan"
echo -e "$blu✘$NC Trojan GO               :$status_trgo"
echo -e "$blu✘$NC Websocket TLS           :$swstls"
echo -e "$blu✘$NC Websocket None TLS      :$swsdrop"
echo -e "$blu✘$NC Websocket Ovpn          :$swsovpn"
echo -e "$blu✘$NC OHP Dropbear            :$sohp"
echo -e "$blu✘$NC OHP OpenVPN             :$sohq"
echo -e "$blu✘$NC OHP SSH                 :$sohr"
echo -e "$blu✘$NC SSL / SSH Multiplexer   :$sosslh"
echo -e "${CYAN}━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━━\033[0m${NC}"
echo ""
